    ...
    async onSubmit() {
      ...
      try {
        ...
        const entry = {
          ...
          status: 'pending',
          mode: this.mode,
          listTarget: this.form.listTarget || 'main',
          player,
        ...
        if (webhook) {
          ...
          if (!this.isImpossible) {
            lines.push('Percent: ' + entry.percent);
            lines.push('Device: ' + entry.device);
            lines.push('Mod menu: ' + entry.modMenu);
            lines.push('Video: ' + entry.link);
          } else {
            lines.push('Showcase: ' + entry.showcase);
          }
