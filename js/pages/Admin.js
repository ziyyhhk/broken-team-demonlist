export default Vue.defineAsyncComponent(async () => {
  ...
  var shMethods = [
    ...
    "    },",
    "    shAddRow() {",
    "      this.serverLevels.push({ id: '', name: '', author: '', victor: '', verification: '', thumbnail: '', length: '', note: '', tags: [], records: [] });",
    "    },",
    "    shMove(i, dir) {",
    "      var j = i + dir;",
  ...
  var newPanel = [
    ...
    '<h2>Server Hardest</h2>',
    '<p class="admin-hint">Victor = who beat it. Video URL = embed. Thumbnail = optional image URL (overrides YouTube poster).</p>',
    ...
    '<input class="admin-input" v-model="lv.thumbnail" placeholder="Thumbnail image URL (optional)" style="flex:1;min-width:10rem" />',
